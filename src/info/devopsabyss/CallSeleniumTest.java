...
public class CallSeleniumTest {
	...
	private long startTest(String className, String baseURL, String browser) throws NoClassDefFoundError, InvocationTargetException, NoSuchMethodException, Exception {

		long t1 = 0;
		long t2 = 0;
		Class seleniumTestClass = null;
		SeleneseTestCase seleniumTest = null;
		...
		try {
			...
			seleniumTest = (SeleneseTestCase)seTestCon.newInstance(null);
			
			// don't call setUp method from generated class, because it will look like this:
			// setUp("http://change-this-to-the-site-you-are-testing/", "*chrome");
			// calls setUp with parameters to overwrite wrong defaults
			Class types[] = {String.class, String.class};
			Method setUp = seleniumTestClass.getMethod("setUp", types);
			String setUpArgs[] = {baseURL, browser};
			setUp.invoke(seleniumTest, setUpArgs);
			...
			*/
			...
			// this is normally not part of the test class generated by the Selenium IDE
	...
	public static void main(String[] args) throws Exception {
		...
		//optionclass.setRequired(true);
		Option optionbaseurl = new Option( "b", "baseUrl", true, "starting point of your test as url (required)       " +
														" e.g. \"http://www.google.com\"");
		//optionbaseurl.setRequired(true);
		Option optiontype = new Option( "t", "browsertype", true, "name of browsertype for selenium test (required)    " +
															" e.g. \"*firefox\"");
		...
		seTest.options.addOption(optionbaseurl);
		seTest.options.addOption(optiontype);
		...
		try {
			...
			if (cmd.hasOption("h") || 
			   (cmd.getOptionValue("c") == null && cmd.getOptionValue("b") == null && cmd.getOptionValue("t") == null)) {
				usage(seTest.options);
				System.exit(nagios_rc);
			}

			time = seTest.startTest(cmd.getOptionValue("c"), cmd.getOptionValue("b"), cmd.getOptionValue("t"));
	...
	private static void usage(Options options) {
		...
		System.out.println(" ./check_selenium -c \"com.example.tests.GoogleSeleniumTestCase\" -b \"http://www.google.com\" -t \"*firefox\"");
		System.out.println(" ./check_selenium --class \"com.example.tests.GoogleSeleniumTestCase\" --baseUrl \"http://www.google.com\" -browsertype \"*firefox\"");
	}
}
